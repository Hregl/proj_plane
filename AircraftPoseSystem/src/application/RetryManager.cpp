...
//
//  依据：SYS-08 §7.1 / §7.3 / §7.4 / §7.6 / §7.7〔引用无效·依据待裁决·见 Q-D2〕、§10（收敛性测试）、§11（约束 6/8）
...
/// 次数用尽时该填哪个错误码。
///
/// 只有 SYS-08 §7.7〔引用无效·依据待裁决·见 Q-D2〕 明确给出码位的四个状态有专属码；其余如实返回 0
                                 ...
                                 uint64_t nowNs)
{
    ...
    // ---- 两个预算都必须满足，取先到者（§7.4〔引用无效·依据待裁决·见 Q-D2〕）----
    //
